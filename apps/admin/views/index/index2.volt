                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/apps/public/templates/admin/dist/img/user2-160x160.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/templates/admin/dist/img/user3-128x128.jpg"
                                                     class="img-circle" alt="User Image"/>
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/templates/admin/dist/img/user4-128x128.jpg"
                                                     class="img-circle" alt="User Image"/>
                                            </div>
                                            <h4>
                                                Developers
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="index.volt"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li class="active"><a href="index2.volt"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/public/templates/admin/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>
                            Top
                            Navigation</a></li>
                        <li><a href="/public/templates/admin/pages/layout/boxed.html"><i class="fa fa-circle-o"></i>
                            Boxed</a>
                        </li>
                        <li><a href="/public/templates/admin/pages/layout/fixed.html"><i class="fa fa-circle-o"></i>
                            Fixed</a>
                        </li>
                        <li><a href="/public/templates/admin/pages/layout/collapsed-sidebar.html"><i
                                class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/public/templates/pages/widgets.html">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/public/templates/admin/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i>
                            ChartJS</a>
                        </li>
                        <li><a href="/public/templates/admin/pages/charts/morris.html"><i class="fa fa-circle-o"></i>
                            Morris</a></li>
                        <li><a href="/public/templates/admin/pages/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a>
                        </li>
                        <li><a href="/public/templates/admin/pages/charts/inline.html"><i class="fa fa-circle-o"></i>
                            Inline
                            charts</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/templates/admin/pages/UI/general.html"><i class="fa fa-circle-o"></i> General</a>
                        </li>
                        <li><a href="/templates/admin/pages/UI/icons.html"><i class="fa fa-circle-o"></i> Icons</a></li>
                        <li><a href="/templates/admin/pages/UI/buttons.html"><i class="fa fa-circle-o"></i> Buttons</a>
                        </li>
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <img class="direct-chat-img"
                                                 src="/templates/admin/dist/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-info -->
                                            <img class="direct-chat-img"
                                                 src="/templates/admin/dist/img/user3-128x128.jpg"
                                                 alt="message user image"/><!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/28/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/templates/admin/dist/img/user7-128x128.jpg"/>
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/20/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/templates/admin/dist/img/user5-128x128.jpg"/>
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">2/10/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/templates/admin/dist/img/user6-128x128.jpg"/>
                                ...
                                <span class="contacts-list-name">
                                  ...
                                  <small class="contacts-list-date pull-right">1/27/2015</small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                         src="/templates/admin/dist/img/user8-128x128.jpg"/>
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="box-body no-padding">
                                    <ul class="users-list clearfix">
                                        <li>
                                            <img src="/templates/admin/dist/img/user1-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Alexander Pierce</a>
                                            <span class="users-list-date">Today</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user8-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Norman</a>
                                            <span class="users-list-date">Yesterday</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user7-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Jane</a>
                                            <span class="users-list-date">12 Jan</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user6-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">John</a>
                                            <span class="users-list-date">12 Jan</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user2-160x160.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Alexander</a>
                                            <span class="users-list-date">13 Jan</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user5-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Sarah</a>
                                            <span class="users-list-date">14 Jan</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user4-128x128.jpg" alt="User Image"/>
                                            <a class="users-list-name" href="#">Nora</a>
                                            <span class="users-list-date">15 Jan</span>
                                        </li>
                                        <li>
                                            <img src="/templates/admin/dist/img/user3-128x128.jpg" alt="User Image"/>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="/templates/admin/pages/examples/invoice.html">OR9842</a></td>
                                    ...
                                    <tr>
                                        <td><a href="/templates/admin/pages/examples/invoice.html">OR1848</a></td>
                                    ...
                                    <tr>
                                        <td><a href="/templates/admin/pages/examples/invoice.html">OR7429</a></td>
                                        <td>iPhone 6 Plus</td>
                            ...
                            <ul class="products-list product-list-in-box">
                                <li class="item">
                                    <div class="product-img">
                                        <img src="/templates/admin/dist/img/default-50x50.gif" alt="Product Image"/>
                                    </div>
...
<!-- ChartJS 1.0.1 -->
<script src="/templates/admin/plugins/chartjs/Chart.min.js" type="text/javascript"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="/templates/admin/dist/js/pages/dashboard2.js" type="text/javascript"></script>
