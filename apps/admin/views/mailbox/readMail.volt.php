                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-read-info">
                                ...
                                <?php if ($contactList && (is_array($contactList) || ($contactList) instanceof Traversable)) { ?>
                                <?php foreach ($contactList as $contact) { ?>


                                <h3><?php echo $contact->getTopic(); ?></h3>
                                <h5>Name: <?php echo $contact->getName(); ?></h5>
                                <h5>From: <?php echo $contact->getEmail(); ?></h5>
                            </div>
